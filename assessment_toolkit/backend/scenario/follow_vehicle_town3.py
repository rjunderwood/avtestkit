...
class ScenarioFollowVehicleTown3:
    ...
    #Metamorphic Tests
    metamorphic_test_target_file = open(CWD + "/backend/scenario/metamorphic_tests/follow_vehicle_town3.json")
    ...
    def run(self):
        ...
        try:
            ...
            #Speed up the vehicle at x 23
            lead_vehicle_target_stop_x = 23
            while(lead_vehicle.get_location().y > lead_vehicle_target_stop_x):
            ...
            #Slow down the vehicle at x 30
            lead_vehicle_target_stop_x = -20
            while(lead_vehicle.get_location().y > lead_vehicle_target_stop_x):
                pass
            ...
            print("Scenario Finished :: Follow Vehicle Town 3") 
    ...
    def handle_results_output(self, world):
        ...
        results_file_name = 'follow_vehicle_town3_' + str(self.get_current_metamorphic_test_index())    
