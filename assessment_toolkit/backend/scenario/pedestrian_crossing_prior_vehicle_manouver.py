...
class ScenarioPedestrianCrossingPriorVehicleManouver:
    ...
    #Metamorphic Tests
    METAMORPHIC_TEST_FILE_LOCATION= CWD + "/backend/scenario/metamorphic_tests/pedestrian_crossing_prior_vehicle_manouver.json"
    ...
    def spawn_pedestrians(self):
        ...
        for i in range(0, self.metamorphic_parameters['pedestrian_adult']):
            spawn_loc = carla.Location(pedestrian_x,pedestrian_y,0.4)
            pedestrian_y-=0.5
