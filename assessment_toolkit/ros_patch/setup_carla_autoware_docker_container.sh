...
sleep 0s  # Waits 5 seconds.
    ##################
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/research-paper/AV-Tester/assessment_toolkit/ros_patch/patch_files/update_vehicle_model.launch.patch %%:/home/autoware/Documents
...
sleep 0s  # Waits 5 seconds.
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/research-paper/AV-Tester/assessment_toolkit/ros_patch/patch_files/update_my_mission_planning.patch %%:/home/autoware/Documents
...
sleep 0s  # Waits 5 seconds.
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/research-paper/AV-Tester/assessment_toolkit/ros_patch/scenarios/intersection_left_turn.sh %%:/home/autoware/Documents

# COPY EGOCAR SCRIPT TO RUNNING DOCKER
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker exec --user autoware -i %% bash /home/autoware/Documents/intersection_left_turn.sh
sleep 0s  # Waits 5 seconds.
# RUN THE EGOCAR SCRIPT
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker exec %% chmod +x /home/autoware/Documents/intersection_left_turn.sh

# MAKE SCRIPT EXECUTABLE
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker exec --user autoware -i %% /home/autoware/Documents/intersection_left_turn.sh
sleep 0s  # Waits 5 seconds.
# RUN SCRIPT
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/research-paper/AV-Tester/assessment_toolkit/ros_patch/run-simulation.bash %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
