...
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/assessment-toolkit/pedestrian-crossing-branch/AV-Tester/assessment_toolkit/ros_patch/scenarios/pedestrian_crossing.sh %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
