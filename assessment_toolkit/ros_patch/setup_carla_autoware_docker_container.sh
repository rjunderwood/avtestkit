...
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/jvlaj/AV-Tester/assessment_toolkit/ros_patch/patch_files/update_vehicle_model.launch.patch %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
# RUN THE PATCH FILE
...
# COPY PATCH FILE TO RUNNING DOCKER
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/jvlaj/AV-Tester/assessment_toolkit/ros_patch/patch_files/update_my_mission_planning.patch %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
# RUN THE PATCH FILE
...
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/jvlaj/AV-Tester/assessment_toolkit/ros_patch/scenarios/follow_vehicle.sh %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
...
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/jvlaj/AV-Tester/assessment_toolkit/ros_patch/run-simulation.bash %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
# # MAKE SCRIPT EXECUTABLE
