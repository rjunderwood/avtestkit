...
sleep 0s  # Waits 5 seconds.
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/research-paper/AV-Tester/assessment_toolkit/ros_patch/scenarios/pedestrian_crossing_prior_vehicle_manouver.sh %%:/home/autoware/Documents
