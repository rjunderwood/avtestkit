...
sleep 0s  # Waits 5 seconds.
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/merge/AV-Tester/assessment_toolkit/ros_patch/scenarios/intersection_left_turn.sh %%:/home/autoware/Documents
