...
docker ps | grep -Eo '([0-9]|[a-z]){12}' | xargs -I %% docker cp /home/riley/Desktop/assessment-toolkit/AV-Tester/ros_patch/scenarios/follow_vehicle.sh %%:/home/autoware/Documents
sleep 0s  # Waits 5 seconds.
