...
def view_container(gui):
    ...
    layout = [[
        ...
        sg.Column(view_results_page(gui,'intersection_left_turn'), key=('view_results_page_intersection_left_turn'),visible=False, scrollable=True, vertical_scroll_only=True)
        ]]
